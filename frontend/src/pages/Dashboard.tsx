                    ...
                    <div className="space-y-10">
                        <div className="flex flex-col md:flex-row justify-between items-end gap-6">
                            <div className="space-y-1">
                                <h2 className="text-3xl font-black text-gray-900 tracking-tighter uppercase">Mes Dernières Traversées</h2>
                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xl font-black text-gray-900">
                                                        {booking.trip ? `${booking.trip.departure_port} → ${booking.trip.arrival_port}` : "Traversée Maritime"}
                                                    </p>
                                                    <div className="flex items-center gap-2 mt-1 text-[11px] text-gray-500 font-bold uppercase tracking-widest">
                                                        ...
                                                        {booking.trip?.departure_time ? new Date(booking.trip.departure_time).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' }) : "--:--"}
                            ...
                            <div className="flex overflow-x-auto pb-8 gap-6 snap-x snap-mandatory hide-scrollbar">
                                {subscriptions.map((sub, idx) => (
                                    <div
                                        ...
                                        className="min-w-[85%] md:min-w-[45%] snap-center cursor-pointer bg-gradient-to-br from-ocean-600 to-ocean-800 rounded-[2.5rem] p-8 text-white shadow-2xl relative overflow-hidden group hover:scale-[1.02] transition-transform border-4 border-transparent hover:border-white/20"
                                    >
                                        ...
                                        <div className="relative z-10 space-y-6">
                                            ...
                                            <div className="pt-4 border-t border-white/10 flex justify-between items-center">
                                                ...
                                                {sub.rfid_card_id && (
                                                    <p className="text-[10px] font-mono bg-black/20 px-2 py-1 rounded text-ocean-200">{sub.rfid_card_id}</p>
                                                )}
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="bg-white rounded-[2rem] w-full max-w-lg overflow-hidden shadow-2xl relative">
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <button
                                    onClick={() => { setViewBadge(null); setLoyaltyTab('ANNUEL'); document.getElementById('catalog')?.scrollIntoView(); }}
