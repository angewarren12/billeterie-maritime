    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-ocean-50/30 py-12">
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                {/* Trip Summary Card */}
                <div className="card mb-6 border-l-4 border-ocean-500 bg-white shadow-xl overflow-hidden">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        <div className="flex-1 space-y-4">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-ocean-600 uppercase tracking-widest">Trajet Aller</p>
                            ...
                            {/* Return */}
                            {returnTrip && (
                                <div className="flex items-start gap-4 pt-4 border-t border-gray-100/50">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black text-primary-600 uppercase tracking-widest">Trajet Retour</p>
                                        <h2 className="text-xl font-black text-gray-900 leading-tight">
                                            {returnTrip.route.departure_port.name} → {returnTrip.route.arrival_port.name}
                                        </h2>
                                        <p className="text-gray-500 text-sm font-bold mt-1">
                                            {new Date(returnTrip.departure_time).toLocaleDateString('fr-FR', { dateStyle: 'full' })} à {new Date(returnTrip.departure_time).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                                        </p>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="lg:text-right bg-gray-50 lg:bg-transparent -mx-6 -mb-6 lg:m-0 p-6 lg:p-0 border-t lg:border-t-0 border-gray-100">
                            <p className="text-xs text-gray-500 uppercase tracking-widest font-bold mb-1">Total {returnTrip ? '(Aller-Retour)' : ''}</p>
                            <p className="text-4xl font-black text-ocean-600">
                                {calculateAmountToPay().toLocaleString()} <span className="text-xl">FCFA</span>
                            </p>
                            {selectedSubscriptionId && (
                                <p className="text-xs text-green-600 font-bold mt-2 flex items-center lg:justify-end gap-1">
                                        ...
                                        <label className="flex items-start gap-4 cursor-pointer group">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-xs text-ocean-600 mt-2 italic">
                                                    {subscriptions[0].plan.allow_multi_passenger
                                                        ? "✅ Le badge peut payer pour tous les passagers de cette commande."
